...
export class PriorityQueue<T> {
   ...
   */
  constructor(minHeap: boolean = true) {
   ...
   */
  public contains(item: T, comparator: (a: T, b: T) => boolean): boolean {
   ...
   */
  public updatePriority(item: T, newPriority: number, comparator: (a: T, b: T) => boolean): boolean {
