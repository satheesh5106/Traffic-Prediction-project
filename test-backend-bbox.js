...
// Backend calculated bbox for Delhi
const backendBbox = '76.99978779118184,28.61400990990991,77.20521220881817,28.79419009009009';

async function testBackendBbox() {
  try {
    console.log('Testing TomTom API with backend bbox...');
    console.log('Backend bbox:', backendBbox);
