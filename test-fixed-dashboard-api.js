...
// Test the fixed TomTom API call for Chennai route (Egmore to Koyambedu)
...
console.log('Testing fixed TomTom API call for Chennai route...');
console.log(`Bounding box: ${minLng},${minLat},${maxLng},${maxLat}`);

// Fixed URL with proper fields parameter syntax (added outer curly braces)
