...
import { type ExprOrString } from "../utils";
 ...
 * ```
 */
export declare function nth(n: number): Expr;
 ...
 * ```
 */
export declare function intRange(start: number | Expr, end?: number | Expr, step?: number | Expr, dtype?: DataType, eager?: false): Expr;
export declare function intRange<DT extends DataType = DataType.Int64>(opts: {
    start: number | Expr;
    end: number | Expr;
    step?: number | Expr;
    dtype?: DT;
...
export declare function intRange(opts: {
    start: number | Expr;
    end: number | Expr;
    step?: number | Expr;
    dtype?: DataType;
...
export declare function intRange<DT extends DataType = DataType.Int64>(start: number | Expr, end?: number | Expr, step?: number | Expr, dtype?: DT, eager?: true): Series<DT>;
/***
...
export declare function cov(a: ExprOrString, b: ExprOrString, ddof?: number): Expr;
/**
...
/** Return the number of elements in the column.
  ...
  ```
*/
export declare function len(): Expr;
/** Get the last value. */
